...
const { NpkuntaInformation } = require("../models/kadapaSchema");
...
const uploadFile = async (req, res) => {
  try {
    ...
    const relativePath = `uploads/kadapa/${req.file.filename}`;
...
const updateInformation = async (req, res) => {
  try {
    ...
    if (req.file) {
      ...
      information.path = `uploads/kadapa/${req.file.filename}`;
    }
...
// API Routes
router.post("/kadapainformations/upload", upload.single("file"), uploadFile);
router.get("/kadapainformations/informations", getInformations);
router.delete("/kadapainformations/informations/:id", deleteInformation);
router.put("/kadapainformations/informations/:id", upload.single("file"), updateInformation);
